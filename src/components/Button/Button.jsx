...
const Button = ({ text }) => {
  return (
    <Link to={"/"}>
      <button className="bg-buttonColor rounded-[60px] px-8 flex gap-2 justify-center items-center py-4 text-[#FFF] text-base font-semibold hover:bg-transparent border hover:border-buttonColor hover:text-buttonColor ease-in-out duration-150 group">
        {text}
        <svg

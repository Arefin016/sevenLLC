      ...
      >
        <div className="xl:py-[150px] py-8 xl:px-[221px] flex flex-col-reverse lg:flex-row lg:gap-[133px] gap-12 px-5">
          <div className="lg:w-[45%]">
            <h1 className="lg:max-w-[595px] text-[#FFF] xl:text-5xl text-2xl lg:text-3xl font-bold lg:leading-[67px]">
              {title}
            </h1>
            <div className="mt-9">
          ...
          <div>
            <p className="max-w-[720px] text-[#FAFBFC] xl:text-xl text-sm md:text-base xl:leading-9">
              {description}
            </p>
          </div>
        </div>

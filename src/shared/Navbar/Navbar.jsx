    ...
    <nav className="container mx-auto">
      <div className="flex justify-between items-center mt-4">
        ...
        <div className="flex items-center justify-center">
          ...
          <div>
            <Link to={"/"}>
              <button className="text-sm font-semibold border-[2px] border-solid border-buttonColor  text-buttonColor px-6 py-2 rounded-[26px] hover:bg-transparent hover:border-buttonColor hover:text-button ease-in-out duration-150">
                Sign up
              </button>
            </Link>
          </div>
